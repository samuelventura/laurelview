...
func TestSdkCleanerBasic(t *testing.T) {
	...
	to.MatchWait(t, 200, "trace", "add", "0/0", "id0")
	cleaner.AddAction("id0", func() {
		log.Trace("action0")
	})
	to.MatchWait(t, 200, "debug", "override", "1/1", "id0")
	to.MatchWait(t, 200, "trace", "remove", "0/0", "id0")
	to.MatchWait(t, 200, "trace", "actionN")
	to.MatchWait(t, 200, "trace", "add", "0/0", "id0")
	cleaner.AddAction("id1", func() {
		log.Trace("action1")
	})
	to.MatchWait(t, 200, "trace", "add", "1/1", "id1")
	cleaner.AddAction("id2", func() {
		log.Trace("action2")
	})
	to.MatchWait(t, 200, "trace", "add", "2/2", "id2")
	cleaner.Remove("id0")
	to.MatchWait(t, 200, "trace", "remove", "2/2", "id0")
	to.MatchWait(t, 200, "trace", "action0")
	cleaner.Remove("id0")
	to.MatchWait(t, 200, "debug", "nf404", "2/2", "id0")
	cleaner.Close()
	to.MatchWait(t, 200, "trace", "remove", "1/1", "id1")
	to.MatchWait(t, 200, "trace", "action1")
	to.MatchWait(t, 200, "trace", "remove", "0/0", "id2")
	...
	to.MatchWait(t, 200, "trace", "add", "0/0", "id3")
	to.MatchWait(t, 200, "trace", "remove", "0/0", "id3")
